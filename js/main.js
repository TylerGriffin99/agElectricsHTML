(function($) {
    ...
    $("#about_img").owlCarousel({
        ...
        nav: true,
        dots: false,
        navText: ['<span class="owl_text"><i class="fa flm fa-long-arrow-left"></i></span>', '<span class="owl_text"><i class="fa flm fa-long-arrow-right"></i></span>'],
    });
    /* =======================================
           Team Section 
       =======================================*/
